...
public class LoaiHinhChiAdapter extends BaseAdapter{
	

   
    Context mcontext;
    ArrayList<DoiTuongLoaiHinhChi> list;
    int currentdangnoban = 0;
    int coutbandangno = 0;
	int coutdangnoban = 0;
	int coutlist = 0;
	int settextbandangno = 0;
    public LoaiHinhChiAdapter(Context context,ArrayList<DoiTuongLoaiHinhChi> list)
    {
    ...
    public void setData(ArrayList<DoiTuongLoaiHinhChi> listdata)
    {
    	list.clear();
