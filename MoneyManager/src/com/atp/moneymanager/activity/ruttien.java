...
public class ruttien extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ruttien);	
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					if (FuncDungChung.GetLanguage(ruttien.this) == 0)
					{
						popupWindow = FuncDungChung.ShowPopupThongBao(ruttien.this, btnSave, back_dim_layout, "Please set your money", "Notification");
					}
					else
					{
						popupWindow = FuncDungChung.ShowPopupThongBao(ruttien.this, btnSave, back_dim_layout, "Bạn Chưa ChĐn Tiền", "Thông Báo");
				...
				if (tientietkiem < 0)
				{
					if (FuncDungChung.GetLanguage(ruttien.this) == 0)
					{
						popupWindow = FuncDungChung.ShowPopupThongBao(ruttien.this, btnSave, back_dim_layout, "Your Withdraw money larger your saving up money", "Notification");
					}
					else
					{
						popupWindow = FuncDungChung.ShowPopupThongBao(ruttien.this, btnSave, back_dim_layout, "Tiền rút lớn hơn tiền trong tài khoản", "Thông Báo");
				...
				FuncDungChung.InsertDataTietKiem(txtDate.getText().toString(),Integer.parseInt(tien),txtGhiChu.getText().toString(),1);
		 ...
		 final RelativeLayout btnGhiChu = (RelativeLayout)findViewById(R.id.btnGhiChu);
	        btnGhiChu.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (FuncDungChung.GetLanguage(ruttien.this) == 0)
						 popupWindow = FuncDungChung.ShowPopupGhichu(ruttien.this,back_dim_layout,btnGhiChu,txtGhiChu,"Note");
					else
						popupWindow = FuncDungChung.ShowPopupGhichu(ruttien.this,back_dim_layout,btnGhiChu,txtGhiChu,"Ghi Chú");
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				popupWindow = FuncDungChung.ShowPopupDate(ruttien.this,back_dim_layout,btnDate,txtDate);
			}
		});
