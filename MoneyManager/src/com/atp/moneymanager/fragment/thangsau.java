...
import nAdapter.AlldateAdapter;
...
public class thangsau extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.thangsau, container, false);

        list = FuncDungChung.GetAllDate();
     
        final ListView list1 = ( ListView )rootView.findViewById( R.id.listView1 );  // List defined in XML ( See Below )
		final AlldateAdapter adapter = new AlldateAdapter( getActivity(),list);
        ...
        txt1.setText("Thu: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllThuMoneyAfterMonth))  + FuncDungChung.GetCurrency());
        txt2.setText("Chi: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllChiMoneyAfterMonth))  + FuncDungChung.GetCurrency());
        if (FuncDungChung.GetLanguage(getActivity()) == 0)
		{
        	txt1.setText("Income: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllThuMoneyAfterMonth))  + FuncDungChung.GetCurrency());
            txt2.setText("Expense: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllChiMoneyAfterMonth))  + FuncDungChung.GetCurrency());
        	txt4.setText("Total:");
		}
