...
public class thangtruoc extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.thangtruoc, container, false);

        list = FuncDungChung.GetAllDateThangTruoc();
        ...
        txt1.setText("Thu: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllThuMoneyBeforeMonth))  + FuncDungChung.GetCurrency());
        txt2.setText("Chi: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllChiMoneyBeforeMonth))  + FuncDungChung.GetCurrency());
        if (FuncDungChung.GetLanguage(getActivity()) == 0)
		{
        	txt1.setText("Income: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllThuMoneyBeforeMonth))  + FuncDungChung.GetCurrency());
            txt2.setText("Expense: " + FuncDungChung.formatso(Integer.toString(FuncDungChung.AllChiMoneyBeforeMonth))  + FuncDungChung.GetCurrency());
        	txt4.setText("Total:");
		}
        return rootView;
    }
