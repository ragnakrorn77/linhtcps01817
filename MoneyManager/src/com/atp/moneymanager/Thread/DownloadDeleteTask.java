...
public class DownloadDeleteTask extends AsyncTask<String, Integer, String> {
    ...
    public DownloadDeleteTask(Context context,String email,String file_name,RelativeLayout loading,LinearLayout linearLayout1) {
    ...
    protected void onPostExecute(String result) {
    	FuncDungChung.SetUser(this.email);
