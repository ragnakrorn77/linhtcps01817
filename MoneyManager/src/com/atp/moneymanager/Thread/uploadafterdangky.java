...
public class uploadafterdangky extends AsyncTask<String,Void,String>{

	Context mContext;
	String email;
	RelativeLayout loading;
	LinearLayout linearLayout1;
	public uploadafterdangky(Context mContext,String email,RelativeLayout loading,LinearLayout linearLayout1)
	{
	...
	@Override
	   protected void onPostExecute(String result){
		...
		Intent localIntent = new Intent(mContext, SlideMenuAttribute.class);
