...
public class DownloadTaskLogin extends AsyncTask<String, Integer, String> {

    private Context context;
    private String file_name;
    RelativeLayout loading;
	LinearLayout linearLayout1;
    public DownloadTaskLogin(Context context,String file_name,RelativeLayout loading,LinearLayout linearLayout1) {
